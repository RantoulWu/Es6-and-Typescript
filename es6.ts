...
// let hahah :any = 'aaa';
// let hahah:any = 'aaa';
/*!!! in typescript, no redeclaration of let */
...
const add1 = (a) => a+1;
const add2 = a => a+1; //if only has one parameter
const add3 = _ => {};   //等价于const add3 = () => {}; if no parameters, can be shortened
add(1,2);
